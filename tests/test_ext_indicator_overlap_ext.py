...
class TestOverlapExtension(TestCase):
    ...
    def test_hilo_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['HILO_13_21',
            'HILOl_13_21', 'HILOs_13_21'])
    ...
    def test_ichimoku_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-5:]), ['ISA_9', 'ISB_26',
            'ITS_9', 'IKS_26', 'ICS_26'])
    ...
    def test_supertrend_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-4:]), ['SUPERT_7_3.0',
