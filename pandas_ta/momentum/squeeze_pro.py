...
import cudf
from cuml.preprocessing.text import simplify_columns
import cupy as cp
...
def squeeze_pro(high, low, close, bb_length=None, bb_std=None, kc_length=None, kc_scalar_wide=None, kc_scalar_normal=None, kc_scalar_narrow=None, mom_length=None, mom_smooth=None, use_tr=None, mamode=None, offset=None, **kwargs):
    ...
    _props += (
        f'_{bb_length}_{bb_std}_{kc_length}_{kc_scalar_wide}_{kc_scalar_normal}_{kc_scalar_narrow}'
        )
    squeeze.name = f'SQZPRO{_props}'
    data = {squeeze.name: squeeze, f'SQZPRO_ON_WIDE': squeeze_on_wide.astype(int) if asint else squeeze_on_wide, 
