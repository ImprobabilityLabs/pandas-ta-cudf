...
class TestTrend(TestCase):
    ...
    def test_aroon(self):
        ...
        try:
            ...
            expecteddf = DataFrame({'AROOND_14': expected[0], 'AROONU_14':
                expected[1]})
            ...
            try:
                aroonu_corr = pandas_ta.utils.df_error_analysis(result.iloc
