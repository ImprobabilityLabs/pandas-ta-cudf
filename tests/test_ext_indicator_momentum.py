...
class TestMomentumExtension(TestCase):
    ...
    def test_fisher_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-2:]), ['FISHERT_9_1',
            'FISHERTs_9_1'])
    ...
    def test_kdj_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['K_9_3', 'D_9_3',
            'J_9_3'])
    ...
    def test_macd_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['MACD_12_26_9',
    ...
    def test_ppo_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['PPO_12_26_9',
            'PPOh_12_26_9', 'PPOs_12_26_9'])
    ...
    def test_pvo_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['PVO_12_26_9',
            'PVOh_12_26_9', 'PVOs_12_26_9'])

    def test_qqe_ext(self):
        self.data.ta.qqe(append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-4:]), ['QQE_14_5_4.236',
    ...
    def test_rvgi_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-2:]), ['RVGI_14_4',
            'RVGIs_14_4'])
    ...
    def test_smi_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['SMI_5_20_5',
            'SMIs_5_20_5', 'SMIo_5_20_5'])
        self.data.ta.smi(scalar=10, append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['SMI_5_20_5_10.0',
            'SMIs_5_20_5_10.0', 'SMIo_5_20_5_10.0'])

    def test_squeeze_ext(self):
        self.data.ta.squeeze(append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-4:]), ['SQZ_20_2.0_20_1.5',
            'SQZ_ON', 'SQZ_OFF', 'SQZ_NO'])
        self.data.ta.squeeze(tr=False, append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-4:]), ['SQZ_ON', 'SQZ_OFF',
            'SQZ_NO', 'SQZhlr_20_2.0_20_1.5'])

    def test_squeeze_pro_ext(self):
        self.data.ta.squeeze_pro(append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-4:]), ['SQZPRO_ON_NORMAL',
            'SQZPRO_ON_NARROW', 'SQZPRO_OFF', 'SQZPRO_NO'])
        self.data.ta.squeeze_pro(tr=False, append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-4:]), ['SQZPRO_ON_NARROW',
            'SQZPRO_OFF', 'SQZPRO_NO', 'SQZPROhlr_20_2.0_20_2_1.5_1'])

    def test_stc_ext(self):
        self.data.ta.stc(append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-3:]), ['STC_10_12_26_0.5',
            'STCmacd_10_12_26_0.5', 'STCstoch_10_12_26_0.5'])

    def test_stoch_ext(self):
        self.data.ta.stoch(append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-2:]), ['STOCHk_14_3_3',
            'STOCHd_14_3_3'])
    ...
    def test_td_seq_ext(self):
        ...
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-2:]), ['TD_SEQ_UP',
            'TD_SEQ_DN'])
        self.data.ta.td_seq(show_all=True, append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-2:]), ['TD_SEQ_UPa',
            'TD_SEQ_DNa'])

    def test_trix_ext(self):
        self.data.ta.trix(append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-2:]), ['TRIX_30_9',
            'TRIXs_30_9'])

    def test_tsi_ext(self):
        self.data.ta.tsi(append=True)
        self.assertIsInstance(self.data, DataFrame)
        self.assertEqual(list(self.data.columns[-2:]), ['TSI_13_25_13',
            'TSIs_13_25_13'])
